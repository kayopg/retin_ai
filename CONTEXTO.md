...
- **Modelo comercial entre os envolvidos.** Se o projeto será uma sociedade ou uma contratação não está definido. Três estruturas foram mapeadas em `docs/negociacao.html` e `docs/proposta-parceria.html`, ambos versionados neste repositório por decisão do usuário em 2026-08-28. Nenhuma estrutura foi escolhida.
